...
class MessageDetailPage extends StatefulWidget {
  ...
  @override
  _MessageDetailPageState createState() => _MessageDetailPageState(type, defaultIndex);
}
...
//Native Ad Close
  ...
  Widget build(BuildContext context) {
    if (type == '1') {
      ...
      // Italian
      data = Messages.italian_data;
    } else if (type == '6') {
      // Portuguese
      data = Messages.portuguese_data;
    } else {
      // Spanish:
    ...
    return PageView.builder(
      controller: PageController(initialPage: defaultIndex, keepPage: true, viewportFraction: 1),
